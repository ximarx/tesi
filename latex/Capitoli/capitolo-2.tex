...
\input{Capitoli/capitolo-2/ucc-1}\clearpage

\subsubsection{UCD-1: Creazione artefatto}

\input{Capitoli/capitolo-2/ucd-1}\clearpage

\subsubsection{UCD-2: Testa artefatto}

\input{Capitoli/capitolo-2/ucd-2}\clearpage

\subsubsection{UCE-1: Modifica funzioni di sistema}

\input{Capitoli/capitolo-2/uce-1}\clearpage

\subsubsection{UCE-2: Monitorizza evento}

\input{Capitoli/capitolo-2/uce-2}\clearpage

\subsubsection{UCE-3: Aggiunge CRS}

\input{Capitoli/capitolo-2/uce-3}\clearpage

\subsubsection{UCE-4: Testa environment}

\input{Capitoli/capitolo-2/uce-4}\clearpage

\subsubsection{UCA-1: Avvia Server}

\input{Capitoli/capitolo-2/uca-1}\clearpage

\subsubsection{UCA-2: Arresta Server}

\input{Capitoli/capitolo-2/uca-2}\clearpage

\subsubsection{UCA-3: Configura Server}

\input{Capitoli/capitolo-2/uca-3}\clearpage

\subsubsection{UCS-1: Analisi dei risultati}

\input{Capitoli/capitolo-2/ucs-1}\clearpage

\subsubsection{UCR-1: Inizializza sessione}

\input{Capitoli/capitolo-2/ucr-1}\clearpage

\subsubsection{UCR-2: Distrugge sessione}

\input{Capitoli/capitolo-2/ucr-2}\clearpage

\subsubsection{UCR-3: Richiede servizio}

\input{Capitoli/capitolo-2/ucr-3}\clearpage
