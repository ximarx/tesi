...
Questa tesi si prefigge l'obiettivo di progettare e quindi implementare un environment per sistemi esperti flessibile che offra un set di funzionalità simili a quelle offerte da CLIPS. A questo scopo, il linguaggio scelto per la realizzazione è Python.

Con la finalità di valutarne le possibilità di integrazione in scenari differenti, verrà inoltre progettata un'interfaccia di utilizzo dello stesso utilizzando il protocollo XMLRPC.
