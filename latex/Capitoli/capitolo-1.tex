...
Realizzando un parallelismo, è possibile considerare l'assegnazione dell'attributo di \emph{esperto} ad un sistema in grado di esibire un comportamento paragonabile a quello di uno esperto umano all'interno di un ambito di dominio focalizzato.
...
\subsection{Meccanismi di inferenza}
